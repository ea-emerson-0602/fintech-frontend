            ...
            <Form className="space-y-4">
              ...
              <div>
                ...
                <Field
                  ...
                  className="w-full mt-1 px-3 py-2 border rounded-md text-black focus:outline-none focus:ring-2 focus:ring-black"
                />
              ...
              <div>
                ...
                <Field
                  ...
                  className="w-full mt-1 px-3 py-2 border text-black rounded-md focus:outline-none focus:ring-2 focus:ring-black"
                />
              ...
              <div>
                ...
                <div className="relative">
                  <Field
                    ...
                    className="w-full mt-1 px-3 py-2 text-black border rounded-md focus:outline-none focus:ring-2 focus:ring-black pr-10"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="terms" className="text-xs text-gray-700">
                  I agree to BeamMarkets <span className="text-blue-600 underline">Terms of Service </span> and <span className="text-blue-600 underline">Privacy Policy</span>
                </label>
              </div>
              ...
              <button
                ...
                className={`w-full py-2 text-white rounded-full transition ${
                  values.terms ? 'bg-black hover:bg-gray-700' : 'bg-gray-500 cursor-not-allowed'
                }`}
              >
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-xl shadow-md text-center max-w-sm w-full">
            <p className="text-lg font-semibold mb-4">Signup method unavailable</p>
            <p className="text-gray-600 mb-6">This signup option is currently not available. Please register with your email instead.</p>
            <button
